...
const classService = __importStar(require("./class.services"));
const createClass = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield classService.createClass(req.body);
...
const getAllClasses = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield classService.getAllClasses();
...
const getClassById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield classService.getClassById(req.params.id);
        if (!result)
...
const updateClass = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield classService.updateClass(req.params.id, req.body);
        if (!result)
            return res.status(404).json({ message: 'Class not found' });
        res.status(200).json(result);
    }
...
const softDeleteClass = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield classService.softDeleteClass(req.params.id);
        if (!result)
            return res.status(404).json({ message: 'Class not found' });
