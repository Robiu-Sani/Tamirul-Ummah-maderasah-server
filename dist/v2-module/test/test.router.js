...
exports.test_tutiral = void 0;
/* eslint-disable @typescript-eslint/no-explicit-any */
const express_1 = __importDefault(require("express"));
const test_controllar_1 = require("./test.controllar");
const router = express_1.default.Router();
const controller = (0, test_controllar_1.testTutorialExamController)();
// Exam routes
