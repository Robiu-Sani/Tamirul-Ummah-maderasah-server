...
exports.testTutorialExamService = void 0;
const test_model_1 = require("./test.model");
exports.testTutorialExamService = {
    // Create new exam
    createExam(examData) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield test_model_1.testTutiral.create(examData);
        });
    },
    ...
    getAllExams(filters, paginationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [data, total] = yield Promise.all([
                test_model_1.testTutiral.find(query).sort(sortOptions).skip(skip).limit(limit).exec(),
                test_model_1.testTutiral.countDocuments(query),
            ]);
            return {
                data,
                page,
    ...
    getExamsWithFailedSubjects(year, paginationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [data, total] = yield Promise.all([
                test_model_1.testTutiral.aggregate([
                    { $match: query },
                    {
                        $addFields: {
                            failedSubjectsCount: {
    ...
    updateExam(id, updateData) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield test_model_1.testTutiral.findByIdAndUpdate(id, updateData, { new: true });
        });
    },
    // Delete exam (soft delete)
    deleteExam(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield test_model_1.testTutiral.findByIdAndUpdate(id, { isDeleted: true }, { new: true });
        });
    },
};
