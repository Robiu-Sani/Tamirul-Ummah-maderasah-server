...
const testTutorialExamSchema = new mongoose_1.Schema({
    userId: {
    ...
    examName: {
        type: String,
        required: true,
        default: `Test ${new Date().getFullYear()}`,
    },
...
exports.testTutiral = mongoose_1.default.model('testTutorialExam', testTutorialExamSchema);
