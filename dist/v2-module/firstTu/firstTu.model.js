...
const FirstTutorialExamSchema = new mongoose_1.Schema({
    userId: {
...
exports.FirstTutiral = mongoose_1.default.model('FirstTutorialExam', FirstTutorialExamSchema);
