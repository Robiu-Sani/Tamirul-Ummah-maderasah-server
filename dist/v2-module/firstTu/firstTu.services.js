...
exports.FirstTutorialExamService = void 0;
const firstTu_model_1 = require("./firstTu.model");
exports.FirstTutorialExamService = {
    // Create new exam
    createExam(examData) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield firstTu_model_1.FirstTutiral.create(examData);
        });
    },
    ...
    getAllExams(filters, paginationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [data, total] = yield Promise.all([
                firstTu_model_1.FirstTutiral.find(query).sort(sortOptions).skip(skip).limit(limit).exec(),
                firstTu_model_1.FirstTutiral.countDocuments(query),
            ]);
            return {
                data,
                page,
    ...
    getExamsWithFailedSubjects(year, paginationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [data, total] = yield Promise.all([
                firstTu_model_1.FirstTutiral.aggregate([
                    { $match: query },
                    {
                        $addFields: {
                            failedSubjectsCount: {
    ...
    updateExam(id, updateData) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield firstTu_model_1.FirstTutiral.findByIdAndUpdate(id, updateData, { new: true });
        });
    },
    // Delete exam (soft delete)
    deleteExam(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield firstTu_model_1.FirstTutiral.findByIdAndUpdate(id, { isDeleted: true }, { new: true });
        });
    },
};
