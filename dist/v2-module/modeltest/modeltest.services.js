...
exports.modeltestTutorialExamService = void 0;
const modeltest_model_1 = require("./modeltest.model");
exports.modeltestTutorialExamService = {
    // Create new exam
    createExam(examData) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield modeltest_model_1.modeltestTutiral.create(examData);
        });
    },
    ...
    getAllExams(filters, paginationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [data, total] = yield Promise.all([
                modeltest_model_1.modeltestTutiral
                    .find(query)
                    .sort(sortOptions)
                    .skip(skip)
                    .limit(limit)
                    .exec(),
                modeltest_model_1.modeltestTutiral.countDocuments(query),
            ]);
            return {
                data,
                page,
    ...
    getExamsWithFailedSubjects(year, paginationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [data, total] = yield Promise.all([
                modeltest_model_1.modeltestTutiral.aggregate([
                    { $match: query },
                    {
                        $addFields: {
                            failedSubjectsCount: {
    ...
    updateExam(id, updateData) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield modeltest_model_1.modeltestTutiral.findByIdAndUpdate(id, updateData, {
                new: true,
            });
        });
    },
    ...
    deleteExam(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield modeltest_model_1.modeltestTutiral.findByIdAndUpdate(id, { isDeleted: true }, { new: true });
        });
    },
};
