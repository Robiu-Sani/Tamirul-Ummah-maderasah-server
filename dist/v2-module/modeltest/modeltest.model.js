...
const modeltestTutorialExamSchema = new mongoose_1.Schema({
    userId: {
...
exports.modeltestTutiral = mongoose_1.default.model('modeltestTutorialExam', modeltestTutorialExamSchema);
