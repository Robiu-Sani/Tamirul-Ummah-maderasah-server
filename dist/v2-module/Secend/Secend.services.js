...
exports.SecendTutorialExamService = void 0;
const Secend_model_1 = require("./Secend.model");
exports.SecendTutorialExamService = {
    // Create new exam
    createExam(examData) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield Secend_model_1.SecendTutiral.create(examData);
        });
    },
    ...
    getAllExams(filters, paginationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [data, total] = yield Promise.all([
                Secend_model_1.SecendTutiral.find(query)
                    .sort(sortOptions)
                    .skip(skip)
                    .limit(limit)
                    .exec(),
                Secend_model_1.SecendTutiral.countDocuments(query),
            ]);
            return {
                data,
                page,
    ...
    getExamsWithFailedSubjects(year, paginationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [data, total] = yield Promise.all([
                Secend_model_1.SecendTutiral.aggregate([
                    { $match: query },
                    {
                        $addFields: {
                            failedSubjectsCount: {
    ...
    updateExam(id, updateData) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield Secend_model_1.SecendTutiral.findByIdAndUpdate(id, updateData, { new: true });
        });
    },
    // Delete exam (soft delete)
    deleteExam(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield Secend_model_1.SecendTutiral.findByIdAndUpdate(id, { isDeleted: true }, { new: true });
        });
    },
};
