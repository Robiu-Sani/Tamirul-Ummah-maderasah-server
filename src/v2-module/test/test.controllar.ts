...
import { testTutorialExamService } from './test.services';

export const testTutorialExamController = () => {
  return {
    // Create new exam
    async createExam(req: Request, res: Response) {
      try {
        const examData = req.body;
        const result = await testTutorialExamService.createExam(examData);
    ...
    async getAllExams(req: Request, res: Response) {
      try {
        ...
        const result = await testTutorialExamService.getAllExams(
          filters,
          paginationOptions,
        );
    ...
    async getExamsByTeacher(req: Request, res: Response) {
      try {
        ...
        const result = await testTutorialExamService.getExamsByTeacher(
          teacherId,
          paginationOptions,
        );
    ...
    async getExamsByUser(req: Request, res: Response) {
      try {
        ...
        const result = await testTutorialExamService.getExamsByUser(
          userId,
          paginationOptions,
        );
    ...
    async getExamsByName(req: Request, res: Response) {
      try {
        ...
        const result = await testTutorialExamService.getExamsByName(
          examName,
          paginationOptions,
        );
    ...
    async getExamsByYear(req: Request, res: Response) {
      try {
        ...
        const result = await testTutorialExamService.getExamsByYear(
          parseInt(year),
          paginationOptions,
        );
    ...
    async getExamsWithFailedSubjects(req: Request, res: Response) {
      try {
        ...
        const result = await testTutorialExamService.getExamsWithFailedSubjects(
          parseInt(year),
          paginationOptions,
        );
    ...
    async updateExam(req: Request, res: Response) {
      try {
        ...
        const result = await testTutorialExamService.updateExam(id, updateData);
    ...
    async deleteExam(req: Request, res: Response) {
      try {
        const { id } = req.params;
        const result = await testTutorialExamService.deleteExam(id);
