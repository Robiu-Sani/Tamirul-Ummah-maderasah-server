...
import { SecendTutorialExamService } from './Secend.services';

export const SecendTutorialExamController = () => {
  return {
    // Create new exam
    async createExam(req: Request, res: Response) {
      try {
        const examData = req.body;
        const result = await SecendTutorialExamService.createExam(examData);
    ...
    async getAllExams(req: Request, res: Response) {
      try {
        ...
        const result = await SecendTutorialExamService.getAllExams(
          filters,
          paginationOptions,
        );
    ...
    async getExamsByTeacher(req: Request, res: Response) {
      try {
        ...
        const result = await SecendTutorialExamService.getExamsByTeacher(
          teacherId,
          paginationOptions,
        );
    ...
    async getExamsByUser(req: Request, res: Response) {
      try {
        ...
        const result = await SecendTutorialExamService.getExamsByUser(
          userId,
          paginationOptions,
        );
    ...
    async getExamsByName(req: Request, res: Response) {
      try {
        ...
        const result = await SecendTutorialExamService.getExamsByName(
          examName,
          paginationOptions,
        );
    ...
    async getExamsByYear(req: Request, res: Response) {
      try {
        ...
        const result = await SecendTutorialExamService.getExamsByYear(
          parseInt(year),
          paginationOptions,
        );
    ...
    async getExamsWithFailedSubjects(req: Request, res: Response) {
      try {
        ...
        const result =
          await SecendTutorialExamService.getExamsWithFailedSubjects(
            parseInt(year),
            paginationOptions,
          );
    ...
    async updateExam(req: Request, res: Response) {
      try {
        ...
        const result = await SecendTutorialExamService.updateExam(
          id,
          updateData,
        );
    ...
    async deleteExam(req: Request, res: Response) {
      try {
        const { id } = req.params;
        const result = await SecendTutorialExamService.deleteExam(id);
