...
import { admitionTutorialExamService } from './admition.services';

export const admitionTutorialExamController = () => {
  return {
    // Create new exam
    async createExam(req: Request, res: Response) {
      try {
        const examData = req.body;
        const result = await admitionTutorialExamService.createExam(examData);
    ...
    async getAllExams(req: Request, res: Response) {
      try {
        ...
        const result = await admitionTutorialExamService.getAllExams(
          filters,
          paginationOptions,
        );
    ...
    async getExamsByTeacher(req: Request, res: Response) {
      try {
        ...
        const result = await admitionTutorialExamService.getExamsByTeacher(
          teacherId,
          paginationOptions,
        );
    ...
    async getExamsByUser(req: Request, res: Response) {
      try {
        ...
        const result = await admitionTutorialExamService.getExamsByUser(
          userId,
          paginationOptions,
        );
    ...
    async getExamsByName(req: Request, res: Response) {
      try {
        ...
        const result = await admitionTutorialExamService.getExamsByName(
          examName,
          paginationOptions,
        );
    ...
    async getExamsByYear(req: Request, res: Response) {
      try {
        ...
        const result = await admitionTutorialExamService.getExamsByYear(
          parseInt(year),
          paginationOptions,
        );
    ...
    async getExamsWithFailedSubjects(req: Request, res: Response) {
      try {
        ...
        const result =
          await admitionTutorialExamService.getExamsWithFailedSubjects(
            parseInt(year),
            paginationOptions,
          );
    ...
    async updateExam(req: Request, res: Response) {
      try {
        ...
        const result = await admitionTutorialExamService.updateExam(
          id,
          updateData,
        );
    ...
    async deleteExam(req: Request, res: Response) {
      try {
        const { id } = req.params;
        const result = await admitionTutorialExamService.deleteExam(id);
