...
import { modeltestTutorialExamService } from './modeltest.services';

export const modeltestTutorialExamController = () => {
  return {
    // Create new exam
    async createExam(req: Request, res: Response) {
      try {
        const examData = req.body;
        const result = await modeltestTutorialExamService.createExam(examData);
    ...
    async getAllExams(req: Request, res: Response) {
      try {
        ...
        const result = await modeltestTutorialExamService.getAllExams(
          filters,
          paginationOptions,
        );
    ...
    async getExamsByTeacher(req: Request, res: Response) {
      try {
        ...
        const result = await modeltestTutorialExamService.getExamsByTeacher(
          teacherId,
          paginationOptions,
        );
    ...
    async getExamsByUser(req: Request, res: Response) {
      try {
        ...
        const result = await modeltestTutorialExamService.getExamsByUser(
          userId,
          paginationOptions,
        );
    ...
    async getExamsByName(req: Request, res: Response) {
      try {
        ...
        const result = await modeltestTutorialExamService.getExamsByName(
          examName,
          paginationOptions,
        );
    ...
    async getExamsByYear(req: Request, res: Response) {
      try {
        ...
        const result = await modeltestTutorialExamService.getExamsByYear(
          parseInt(year),
          paginationOptions,
        );
    ...
    async getExamsWithFailedSubjects(req: Request, res: Response) {
      try {
        ...
        const result =
          await modeltestTutorialExamService.getExamsWithFailedSubjects(
            parseInt(year),
            paginationOptions,
          );
    ...
    async updateExam(req: Request, res: Response) {
      try {
        ...
        const result = await modeltestTutorialExamService.updateExam(
          id,
          updateData,
        );
    ...
    async deleteExam(req: Request, res: Response) {
      try {
        const { id } = req.params;
        const result = await modeltestTutorialExamService.deleteExam(id);
