...
import { FirstTutorialExamService } from './firstTu.services';

export const FirstTutorialExamController = () => {
  return {
    // Create new exam
    async createExam(req: Request, res: Response) {
      try {
        const examData = req.body;
        const result = await FirstTutorialExamService.createExam(examData);
    ...
    async getAllExams(req: Request, res: Response) {
      try {
        ...
        const result = await FirstTutorialExamService.getAllExams(
          filters,
          paginationOptions,
        );
    ...
    async getExamsByTeacher(req: Request, res: Response) {
      try {
        ...
        const result = await FirstTutorialExamService.getExamsByTeacher(
          teacherId,
          paginationOptions,
        );
    ...
    async getExamsByUser(req: Request, res: Response) {
      try {
        ...
        const result = await FirstTutorialExamService.getExamsByUser(
          userId,
          paginationOptions,
        );
    ...
    async getExamsByName(req: Request, res: Response) {
      try {
        ...
        const result = await FirstTutorialExamService.getExamsByName(
          examName,
          paginationOptions,
        );
    ...
    async getExamsByYear(req: Request, res: Response) {
      try {
        ...
        const result = await FirstTutorialExamService.getExamsByYear(
          parseInt(year),
          paginationOptions,
        );
    ...
    async getExamsWithFailedSubjects(req: Request, res: Response) {
      try {
        ...
        const result =
          await FirstTutorialExamService.getExamsWithFailedSubjects(
            parseInt(year),
            paginationOptions,
          );
    ...
    async updateExam(req: Request, res: Response) {
      try {
        ...
        const result = await FirstTutorialExamService.updateExam(
          id,
          updateData,
        );
    ...
    async deleteExam(req: Request, res: Response) {
      try {
        const { id } = req.params;
        const result = await FirstTutorialExamService.deleteExam(id);
